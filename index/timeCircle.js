...
function changeMenuByY(){
    getScrollTop();
    if(scrollPosition<clsZoneY[0]-300){
        var last=document.getElementsByClassName('currentY')[0];
        if(last)last.classList.remove('currentY');
    }else if(scrollPosition>=clsZoneY[0]-300&&scrollPosition<clsZoneY[1]-300){
        chgClass('currentY',document.getElementById('firstLink'));
    }else if(scrollPosition>=clsZoneY[1]-300&&scrollPosition<clsZoneY[2]-300){
        chgClass('currentY',document.getElementById('secondLink'));
    }else if(scrollPosition>=clsZoneY[2]-300&&scrollPosition<clsZoneY[3]-300){
        chgClass('currentY',document.getElementById('thirdLink'));
    }else if(scrollPosition>=clsZoneY[3]-300&&scrollPosition<clsZoneY[4]-300){
        chgClass('currentY',document.getElementById('fourthLink'));
    }else if(scrollPosition>=clsZoneY[4]-300&&scrollPosition<clsZoneY[5]-300){
        chgClass('currentY',document.getElementById('fifthLink'));
    }else if(scrollPosition>=clsZoneY[5]-300&&scrollPosition<clsZoneY[6]-300){
        chgClass('currentY',document.getElementById('sixthLink'));
    }else if(scrollPosition>=clsZoneY[6]-300&&scrollPosition<clsZoneY[7]-300){
        chgClass('currentY',document.getElementById('seventhLink'));
    }else if(scrollPosition>=clsZoneY[7]-300){
