...
function splitTextInSpans(elem) {
  ...
  function intro() {
    ...
    function animateBackground(tl) {
      ...
      function animateLines(lines) {var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
          ...
          // 3d rotation
        } catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator.return) {_iterator.return();}} finally {if (_didIteratorError) {throw _iteratorError;}}}var rotate = function rotate(rx, ry) {
        ...
        trackerLayer.addEventListener('mousemove', function (e) {return window.requestAnimationFrame(function () {return update(wrapper, e);});});
  
        if (window.DeviceOrientationEvent) {
          window.addEventListener('deviceorientation', function (e) {return (
              window.requestAnimationFrame(function () {return update(wrapper, e, true);}));});
        }
      }
